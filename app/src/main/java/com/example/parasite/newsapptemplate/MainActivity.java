...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<ArticleItem>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArticleItemAdapter(this, new ArrayList<ArticleItem>());
        ...
        articleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ArticleItem currentArticleRead = mAdapter.getItem(position);
    ...
    @Override
    public void onLoadFinished(Loader<List<ArticleItem>> loader, List<ArticleItem> data) {
        Log.i(LOG_TAG, "OnLoadFinished() run");
        // Clear the adapter of previous articles information
        mAdapter.clear();
    ...
    @Override
    public Loader<List<ArticleItem>> onCreateLoader(int id, Bundle args) {
        Log.i(LOG_TAG, " OnCreateLoader run ");
        // Create new loader
        return new ArticlesLoader(this, query);
    }

    @Override
    public void onLoaderReset(Loader<List<ArticleItem>> loader) {
